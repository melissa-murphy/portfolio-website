...
const StyledButton = styled.button.attrs(props => ({
	...
	background-color: ${props =>
		props.backgroundColor ? props.backgroundColor : props.theme.secondary.dark};
	color: ${props => (props.color ? props.color : props.theme.color.white)};
	outline: ${props => (props.outline ? props.outline : null)};
	cursor: pointer;
	margin: ${props => (props.margin ? `${props.margin}rem` : "0 auto")};
	padding: ${props => (props.padding ? `${props.margin}rem` : "0")};
	display: flex;
	align-items: center;
